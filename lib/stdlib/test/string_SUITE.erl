...
do_measure(DataDir) ->
    ...
    Do2(split, repeat(fun() -> string:find(S0, "xy..") end), list),
    Do2(split, repeat(fun() -> string:find(S0B, "xy..") end), binary),
    ...
    Do2(split_t, repeat(fun() -> string:find(S0, "y..", trailing) end), list),
    Do2(split_t, repeat(fun() -> string:find(S0B, "y..", trailing) end), binary),
