...
refreshRect(This,Rect={RectX,RectY,RectW,RectH} = Rect)
...
setSizeHints(This,MinSize={MinSizeW,MinSizeH} = MinSize)
...
setVirtualSizeHints(This,MinSize={MinSizeW,MinSizeH} = MinSize)
 when is_record(This, wx_ref),is_integer(MinSizeW),is_integer(MinSizeH) ->
