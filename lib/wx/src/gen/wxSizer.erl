...
add(#wx_ref{type=ThisT}=This,#wx_ref{type=WindowT}=Window,#wx_ref{type=FlagsT}=Flags) ->
  ...
  wxe_util:queue_cmd(This,Window,Flags,?get_env(),WindowOP),
  wxe_util:rec(WindowOP).
...
detach(#wx_ref{type=ThisT}=This,Index)
 when is_integer(Index) ->
  ?CLASS(ThisT,wxSizer),
  wxe_util:queue_cmd(This,Index,?get_env(),?wxSizer_Detach_1_0),
...
detach(#wx_ref{type=ThisT}=This,#wx_ref{type=WindowT}=Window) ->
  ...
  wxe_util:queue_cmd(This,Window,?get_env(),WindowOP),
  wxe_util:rec(WindowOP).
...
insert(#wx_ref{type=ThisT}=This,Index,#wx_ref{type=WindowT}=Window,#wx_ref{type=FlagsT}=Flags)
 when is_integer(Index) ->
  ...
  wxe_util:queue_cmd(This,Index,Window,Flags,?get_env(),WindowOP),
  wxe_util:rec(WindowOP).
...
isShown(#wx_ref{type=ThisT}=This,Index)
 when is_integer(Index) ->
  ?CLASS(ThisT,wxSizer),
  wxe_util:queue_cmd(This,Index,?get_env(),?wxSizer_IsShown_1_0),
...
-spec recalcSizes(This) -> 'ok' when
	This::wxSizer().
recalcSizes(#wx_ref{type=ThisT}=This) ->
  ?CLASS(ThisT,wxSizer),
  wxe_util:queue_cmd(This,?get_env(),?wxSizer_RecalcSizes).
...
setDimension(#wx_ref{type=ThisT}=This,X,Y,Width,Height)
 when is_integer(X),is_integer(Y),is_integer(Width),is_integer(Height) ->
  ?CLASS(ThisT,wxSizer),
  wxe_util:queue_cmd(This,X,Y,Width,Height,?get_env(),?wxSizer_SetDimension).
...
setItemMinSize(#wx_ref{type=ThisT}=This,Index,{SizeW,SizeH} = Size)
 when is_integer(Index),is_integer(SizeW),is_integer(SizeH) ->
  ?CLASS(ThisT,wxSizer),
  wxe_util:queue_cmd(This,Index,Size,?get_env(),?wxSizer_SetItemMinSize_2_0),
...
setItemMinSize(#wx_ref{type=ThisT}=This,#wx_ref{type=WindowT}=Window,{SizeW,SizeH} = Size)
 when is_integer(SizeW),is_integer(SizeH) ->
  ...
  wxe_util:queue_cmd(This,Window,Size,?get_env(),WindowOP),
  wxe_util:rec(WindowOP).
...
setItemMinSize(#wx_ref{type=ThisT}=This,Index,Width,Height)
 when is_integer(Index),is_integer(Width),is_integer(Height) ->
  ?CLASS(ThisT,wxSizer),
  wxe_util:queue_cmd(This,Index,Width,Height,?get_env(),?wxSizer_SetItemMinSize_3_0),
...
setItemMinSize(#wx_ref{type=ThisT}=This,#wx_ref{type=WindowT}=Window,Width,Height)
 when is_integer(Width),is_integer(Height) ->
  ...
  wxe_util:queue_cmd(This,Window,Width,Height,?get_env(),WindowOP),
  wxe_util:rec(WindowOP).
...
-spec setVirtualSizeHints(This, Window) -> 'ok' when
	This::wxSizer(), Window::wxWindow:wxWindow().
setVirtualSizeHints(#wx_ref{type=ThisT}=This,#wx_ref{type=WindowT}=Window) ->
  ?CLASS(ThisT,wxSizer),
  ?CLASS(WindowT,wxWindow),
  wxe_util:queue_cmd(This,Window,?get_env(),?wxSizer_SetVirtualSizeHints).
