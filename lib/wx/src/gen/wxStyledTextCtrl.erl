...
addStyledText(#wx_ref{type=ThisT}=This,#wx_ref{type=DataT}=Data) ->
  ?CLASS(ThisT,wxStyledTextCtrl),
  ?CLASS(DataT,wxMemoryBuffer),
  wxe_util:queue_cmd(This,Data,?get_env(),?wxStyledTextCtrl_AddStyledText).
...
getStyledText(#wx_ref{type=ThisT}=This,StartPos,EndPos)
 when is_integer(StartPos),is_integer(EndPos) ->
  ?CLASS(ThisT,wxStyledTextCtrl),
  wxe_util:queue_cmd(This,StartPos,EndPos,?get_env(),?wxStyledTextCtrl_GetStyledText),
  wxe_util:rec(?wxStyledTextCtrl_GetStyledText).
...
markerLineFromHandle(#wx_ref{type=ThisT}=This,Handle)
 when is_integer(Handle) ->
  ?CLASS(ThisT,wxStyledTextCtrl),
  wxe_util:queue_cmd(This,Handle,?get_env(),?wxStyledTextCtrl_MarkerLineFromHandle),
...
-spec markerDeleteHandle(This, Handle) -> 'ok' when
	This::wxStyledTextCtrl(), Handle::integer().
markerDeleteHandle(#wx_ref{type=ThisT}=This,Handle)
 when is_integer(Handle) ->
  ?CLASS(ThisT,wxStyledTextCtrl),
  wxe_util:queue_cmd(This,Handle,?get_env(),?wxStyledTextCtrl_MarkerDeleteHandle).
...
-spec gotoPos(This, Pos) -> 'ok' when
	This::wxStyledTextCtrl(), Pos::integer().
gotoPos(#wx_ref{type=ThisT}=This,Pos)
 when is_integer(Pos) ->
  ?CLASS(ThisT,wxStyledTextCtrl),
  wxe_util:queue_cmd(This,Pos,?get_env(),?wxStyledTextCtrl_GotoPos).
...
setAnchor(#wx_ref{type=ThisT}=This,PosAnchor)
 when is_integer(PosAnchor) ->
  ?CLASS(ThisT,wxStyledTextCtrl),
  wxe_util:queue_cmd(This,PosAnchor,?get_env(),?wxStyledTextCtrl_SetAnchor).
...
startStyling(#wx_ref{type=ThisT}=This,Pos,Mask)
 when is_integer(Pos),is_integer(Mask) ->
  ?CLASS(ThisT,wxStyledTextCtrl),
  wxe_util:queue_cmd(This,Pos,Mask,?get_env(),?wxStyledTextCtrl_StartStyling).
...
markerAddSet(#wx_ref{type=ThisT}=This,Line,Set)
 when is_integer(Line),is_integer(Set) ->
  ?CLASS(ThisT,wxStyledTextCtrl),
  wxe_util:queue_cmd(This,Line,Set,?get_env(),?wxStyledTextCtrl_MarkerAddSet).
...
styleSetEOLFilled(#wx_ref{type=ThisT}=This,Style,Filled)
 when is_integer(Style),is_boolean(Filled) ->
  ?CLASS(ThisT,wxStyledTextCtrl),
  wxe_util:queue_cmd(This,Style,Filled,?get_env(),?wxStyledTextCtrl_StyleSetEOLFilled).
...
styleSetCase(#wx_ref{type=ThisT}=This,Style,CaseForce)
 when is_integer(Style),is_integer(CaseForce) ->
  ?CLASS(ThisT,wxStyledTextCtrl),
  wxe_util:queue_cmd(This,Style,CaseForce,?get_env(),?wxStyledTextCtrl_StyleSetCase).
...
indicatorSetStyle(#wx_ref{type=ThisT}=This,Indic,Style)
 when is_integer(Indic),is_integer(Style) ->
  ?CLASS(ThisT,wxStyledTextCtrl),
  wxe_util:queue_cmd(This,Indic,Style,?get_env(),?wxStyledTextCtrl_IndicatorSetStyle).
...
indicatorGetStyle(#wx_ref{type=ThisT}=This,Indic)
 when is_integer(Indic) ->
  ?CLASS(ThisT,wxStyledTextCtrl),
  wxe_util:queue_cmd(This,Indic,?get_env(),?wxStyledTextCtrl_IndicatorGetStyle),
...
indicatorSetForeground(#wx_ref{type=ThisT}=This,Indic,Fore)
 when is_integer(Indic),tuple_size(Fore) =:= 3; tuple_size(Fore) =:= 4 ->
  ?CLASS(ThisT,wxStyledTextCtrl),
  wxe_util:queue_cmd(This,Indic,wxe_util:color(Fore),?get_env(),?wxStyledTextCtrl_IndicatorSetForeground).
...
-spec indicatorGetForeground(This, Indic) -> wx:wx_colour4() when
	This::wxStyledTextCtrl(), Indic::integer().
indicatorGetForeground(#wx_ref{type=ThisT}=This,Indic)
 when is_integer(Indic) ->
  ?CLASS(ThisT,wxStyledTextCtrl),
  wxe_util:queue_cmd(This,Indic,?get_env(),?wxStyledTextCtrl_IndicatorGetForeground),
...
setLineIndentation(#wx_ref{type=ThisT}=This,Line,IndentSize)
 when is_integer(Line),is_integer(IndentSize) ->
  ?CLASS(ThisT,wxStyledTextCtrl),
  wxe_util:queue_cmd(This,Line,IndentSize,?get_env(),?wxStyledTextCtrl_SetLineIndentation).
...
-spec setUseHorizontalScrollBar(This, Show) -> 'ok' when
	This::wxStyledTextCtrl(), Show::boolean().
setUseHorizontalScrollBar(#wx_ref{type=ThisT}=This,Show)
 when is_boolean(Show) ->
  ?CLASS(ThisT,wxStyledTextCtrl),
  wxe_util:queue_cmd(This,Show,?get_env(),?wxStyledTextCtrl_SetUseHorizontalScrollBar).
...
-spec setIndentationGuides(This, Show) -> 'ok' when
	This::wxStyledTextCtrl(), Show::boolean().
setIndentationGuides(#wx_ref{type=ThisT}=This,Show)
 when is_boolean(Show) ->
  ?CLASS(ThisT,wxStyledTextCtrl),
  wxe_util:queue_cmd(This,Show,?get_env(),?wxStyledTextCtrl_SetIndentationGuides).
...
-spec setCurrentPos(This, Pos) -> 'ok' when
	This::wxStyledTextCtrl(), Pos::integer().
setCurrentPos(#wx_ref{type=ThisT}=This,Pos)
 when is_integer(Pos) ->
  ?CLASS(ThisT,wxStyledTextCtrl),
  wxe_util:queue_cmd(This,Pos,?get_env(),?wxStyledTextCtrl_SetCurrentPos).
...
-spec setSelectionStart(This, Pos) -> 'ok' when
	This::wxStyledTextCtrl(), Pos::integer().
setSelectionStart(#wx_ref{type=ThisT}=This,Pos)
 when is_integer(Pos) ->
  ?CLASS(ThisT,wxStyledTextCtrl),
  wxe_util:queue_cmd(This,Pos,?get_env(),?wxStyledTextCtrl_SetSelectionStart).
...
-spec setSelectionEnd(This, Pos) -> 'ok' when
	This::wxStyledTextCtrl(), Pos::integer().
setSelectionEnd(#wx_ref{type=ThisT}=This,Pos)
 when is_integer(Pos) ->
  ?CLASS(ThisT,wxStyledTextCtrl),
  wxe_util:queue_cmd(This,Pos,?get_env(),?wxStyledTextCtrl_SetSelectionEnd).
...
setSelection(#wx_ref{type=ThisT}=This,Start,End)
 when is_integer(Start),is_integer(End) ->
  ?CLASS(ThisT,wxStyledTextCtrl),
  wxe_util:queue_cmd(This,Start,End,?get_env(),?wxStyledTextCtrl_SetSelection).
...
hideSelection(#wx_ref{type=ThisT}=This,Normal)
 when is_boolean(Normal) ->
  ?CLASS(ThisT,wxStyledTextCtrl),
  wxe_util:queue_cmd(This,Normal,?get_env(),?wxStyledTextCtrl_HideSelection).
...
-spec setTargetStart(This, Pos) -> 'ok' when
	This::wxStyledTextCtrl(), Pos::integer().
setTargetStart(#wx_ref{type=ThisT}=This,Pos)
 when is_integer(Pos) ->
  ?CLASS(ThisT,wxStyledTextCtrl),
  wxe_util:queue_cmd(This,Pos,?get_env(),?wxStyledTextCtrl_SetTargetStart).
...
-spec setTargetEnd(This, Pos) -> 'ok' when
	This::wxStyledTextCtrl(), Pos::integer().
setTargetEnd(#wx_ref{type=ThisT}=This,Pos)
 when is_integer(Pos) ->
  ?CLASS(ThisT,wxStyledTextCtrl),
  wxe_util:queue_cmd(This,Pos,?get_env(),?wxStyledTextCtrl_SetTargetEnd).
...
setSearchFlags(#wx_ref{type=ThisT}=This,Flags)
 when is_integer(Flags) ->
  ?CLASS(ThisT,wxStyledTextCtrl),
  wxe_util:queue_cmd(This,Flags,?get_env(),?wxStyledTextCtrl_SetSearchFlags).
...
-spec callTipSetHighlight(This, Start, End) -> 'ok' when
	This::wxStyledTextCtrl(), Start::integer(), End::integer().
callTipSetHighlight(#wx_ref{type=ThisT}=This,Start,End)
 when is_integer(Start),is_integer(End) ->
  ?CLASS(ThisT,wxStyledTextCtrl),
  wxe_util:queue_cmd(This,Start,End,?get_env(),?wxStyledTextCtrl_CallTipSetHighlight).
...
-spec visibleFromDocLine(This, Line) -> integer() when
	This::wxStyledTextCtrl(), Line::integer().
visibleFromDocLine(#wx_ref{type=ThisT}=This,Line)
 when is_integer(Line) ->
  ?CLASS(ThisT,wxStyledTextCtrl),
  wxe_util:queue_cmd(This,Line,?get_env(),?wxStyledTextCtrl_VisibleFromDocLine),
...
docLineFromVisible(#wx_ref{type=ThisT}=This,LineDisplay)
 when is_integer(LineDisplay) ->
  ?CLASS(ThisT,wxStyledTextCtrl),
  wxe_util:queue_cmd(This,LineDisplay,?get_env(),?wxStyledTextCtrl_DocLineFromVisible),
...
-spec wrapCount(This, Line) -> integer() when
	This::wxStyledTextCtrl(), Line::integer().
wrapCount(#wx_ref{type=ThisT}=This,Line)
 when is_integer(Line) ->
  ?CLASS(ThisT,wxStyledTextCtrl),
  wxe_util:queue_cmd(This,Line,?get_env(),?wxStyledTextCtrl_WrapCount),
...
-spec setWrapMode(This, Mode) -> 'ok' when
	This::wxStyledTextCtrl(), Mode::integer().
setWrapMode(#wx_ref{type=ThisT}=This,Mode)
 when is_integer(Mode) ->
  ?CLASS(ThisT,wxStyledTextCtrl),
  wxe_util:queue_cmd(This,Mode,?get_env(),?wxStyledTextCtrl_SetWrapMode).
...
-spec setLayoutCache(This, Mode) -> 'ok' when
	This::wxStyledTextCtrl(), Mode::integer().
setLayoutCache(#wx_ref{type=ThisT}=This,Mode)
 when is_integer(Mode) ->
  ?CLASS(ThisT,wxStyledTextCtrl),
  wxe_util:queue_cmd(This,Mode,?get_env(),?wxStyledTextCtrl_SetLayoutCache).
...
-spec setUseVerticalScrollBar(This, Show) -> 'ok' when
	This::wxStyledTextCtrl(), Show::boolean().
setUseVerticalScrollBar(#wx_ref{type=ThisT}=This,Show)
 when is_boolean(Show) ->
  ?CLASS(ThisT,wxStyledTextCtrl),
  wxe_util:queue_cmd(This,Show,?get_env(),?wxStyledTextCtrl_SetUseVerticalScrollBar).
...
braceHighlight(#wx_ref{type=ThisT}=This,Pos1,Pos2)
 when is_integer(Pos1),is_integer(Pos2) ->
  ?CLASS(ThisT,wxStyledTextCtrl),
  wxe_util:queue_cmd(This,Pos1,Pos2,?get_env(),?wxStyledTextCtrl_BraceHighlight).
...
setModEventMask(#wx_ref{type=ThisT}=This,Mask)
 when is_integer(Mask) ->
  ?CLASS(ThisT,wxStyledTextCtrl),
  wxe_util:queue_cmd(This,Mask,?get_env(),?wxStyledTextCtrl_SetModEventMask).
...
-spec setEdgeMode(This, Mode) -> 'ok' when
	This::wxStyledTextCtrl(), Mode::integer().
setEdgeMode(#wx_ref{type=ThisT}=This,Mode)
 when is_integer(Mode) ->
  ?CLASS(ThisT,wxStyledTextCtrl),
  wxe_util:queue_cmd(This,Mode,?get_env(),?wxStyledTextCtrl_SetEdgeMode).
...
usePopUp(#wx_ref{type=ThisT}=This,AllowPopUp)
 when is_boolean(AllowPopUp) ->
  ?CLASS(ThisT,wxStyledTextCtrl),
  wxe_util:queue_cmd(This,AllowPopUp,?get_env(),?wxStyledTextCtrl_UsePopUp).
...
setZoom(#wx_ref{type=ThisT}=This,Zoom)
 when is_integer(Zoom) ->
  ?CLASS(ThisT,wxStyledTextCtrl),
  wxe_util:queue_cmd(This,Zoom,?get_env(),?wxStyledTextCtrl_SetZoom).
...
setStatus(#wx_ref{type=ThisT}=This,StatusCode)
 when is_integer(StatusCode) ->
  ?CLASS(ThisT,wxStyledTextCtrl),
  wxe_util:queue_cmd(This,StatusCode,?get_env(),?wxStyledTextCtrl_SetStatus).
...
-spec setSelectionMode(This, Mode) -> 'ok' when
	This::wxStyledTextCtrl(), Mode::integer().
setSelectionMode(#wx_ref{type=ThisT}=This,Mode)
 when is_integer(Mode) ->
  ?CLASS(ThisT,wxStyledTextCtrl),
  wxe_util:queue_cmd(This,Mode,?get_env(),?wxStyledTextCtrl_SetSelectionMode).
...
doDragOver(#wx_ref{type=ThisT}=This,X,Y,Def)
 when is_integer(X),is_integer(Y),is_integer(Def) ->
  ?CLASS(ThisT,wxStyledTextCtrl),
  wxe_util:queue_cmd(This,X,Y,Def,?get_env(),?wxStyledTextCtrl_DoDragOver),
...
addTextRaw(#wx_ref{type=ThisT}=This,Text)
 when is_binary(Text) ->
  ?CLASS(ThisT,wxStyledTextCtrl),
  wxe_util:queue_cmd(This,Text,?get_env(),?wxStyledTextCtrl_AddTextRaw).
...
-spec appendTextRaw(This, Text) -> 'ok' when
	This::wxStyledTextCtrl(), Text::binary().
appendTextRaw(#wx_ref{type=ThisT}=This,Text)
 when is_binary(Text) ->
  ?CLASS(ThisT,wxStyledTextCtrl),
  wxe_util:queue_cmd(This,Text,?get_env(),?wxStyledTextCtrl_AppendTextRaw).
