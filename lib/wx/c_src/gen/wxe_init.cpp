...
void WxeApp::init_nonconsts(wxeMemEnv *memenv, ErlNifPid caller) {
  ...
  ERL_NIF_TERM consts[] = {
    ...
    enif_make_tuple2(rt.env, rt.make_atom("wxDEFAULT_CONTROL_BORDER"), rt.make_int(wxDEFAULT_CONTROL_BORDER)),
    enif_make_tuple2(rt.env, rt.make_atom("wxHAS_INT64"), rt.make_int(wxHAS_INT64)),
    enif_make_tuple2(rt.env, rt.make_atom("wxRETAINED"), rt.make_int(wxRETAINED)),
    enif_make_tuple2(rt.env, rt.make_atom("wxGAUGE_EMULATE_INDETERMINATE_MODE"), rt.make_int(wxGAUGE_EMULATE_INDETERMINATE_MODE)),
    ...
    enif_make_tuple2(rt.env, rt.make_atom("wxBETA_NUMBER"), rt.make_int(wxBETA_NUMBER)),
    ...
    enif_make_tuple2(rt.env, rt.make_atom("WX_GL_SAMPLES"), rt.make_int(WX_GL_SAMPLES)),
#else
    enif_make_tuple2(rt.env, rt.make_atom("WX_GL_SAMPLES"), WXE_ATOM_undefined),
#endif
#if wxCHECK_VERSION(3,0,0)
    enif_make_tuple2(rt.env, rt.make_atom("WX_GL_SAMPLE_BUFFERS"), rt.make_int(WX_GL_SAMPLE_BUFFERS)),
#else
    ...
    enif_make_tuple2(rt.env, rt.make_atom("wxBLACK_BRUSH"),rt.make_ref(getRef((void *)wxBLACK_BRUSH,memenv), "wxBrush")),
    enif_make_tuple2(rt.env, rt.make_atom("wxBLACK_DASHED_PEN"),rt.make_ref(getRef((void *)wxBLACK_DASHED_PEN,memenv), "wxPen")),
    enif_make_tuple2(rt.env, rt.make_atom("wxBLACK_PEN"),rt.make_ref(getRef((void *)wxBLACK_PEN,memenv), "wxPen")),
    enif_make_tuple2(rt.env, rt.make_atom("wxBLUE"), rt.make(*(wxBLUE))),
    enif_make_tuple2(rt.env, rt.make_atom("wxBLUE_BRUSH"),rt.make_ref(getRef((void *)wxBLUE_BRUSH,memenv), "wxBrush")),
    enif_make_tuple2(rt.env, rt.make_atom("wxCROSS_CURSOR"),rt.make_ref(getRef((void *)wxCROSS_CURSOR,memenv), "wxCursor")),
    enif_make_tuple2(rt.env, rt.make_atom("wxCYAN"), rt.make(*(wxCYAN))),
    enif_make_tuple2(rt.env, rt.make_atom("wxCYAN_BRUSH"),rt.make_ref(getRef((void *)wxCYAN_BRUSH,memenv), "wxBrush")),
    enif_make_tuple2(rt.env, rt.make_atom("wxCYAN_PEN"),rt.make_ref(getRef((void *)wxCYAN_PEN,memenv), "wxPen")),
    ...
    enif_make_tuple2(rt.env, rt.make_atom("wxGREEN_BRUSH"),rt.make_ref(getRef((void *)wxGREEN_BRUSH,memenv), "wxBrush")),
    enif_make_tuple2(rt.env, rt.make_atom("wxGREEN_PEN"),rt.make_ref(getRef((void *)wxGREEN_PEN,memenv), "wxPen")),
    enif_make_tuple2(rt.env, rt.make_atom("wxGREY_BRUSH"),rt.make_ref(getRef((void *)wxGREY_BRUSH,memenv), "wxBrush")),
    enif_make_tuple2(rt.env, rt.make_atom("wxGREY_PEN"),rt.make_ref(getRef((void *)wxGREY_PEN,memenv), "wxPen")),
    enif_make_tuple2(rt.env, rt.make_atom("wxHOURGLASS_CURSOR"),rt.make_ref(getRef((void *)wxHOURGLASS_CURSOR,memenv), "wxCursor")),
    enif_make_tuple2(rt.env, rt.make_atom("wxITALIC_FONT"),rt.make_ref(getRef((void *)wxITALIC_FONT,memenv), "wxFont")),
    enif_make_tuple2(rt.env, rt.make_atom("wxLIGHT_GREY"), rt.make(*(wxLIGHT_GREY))),
    enif_make_tuple2(rt.env, rt.make_atom("wxLIGHT_GREY_BRUSH"),rt.make_ref(getRef((void *)wxLIGHT_GREY_BRUSH,memenv), "wxBrush")),
    enif_make_tuple2(rt.env, rt.make_atom("wxLIGHT_GREY_PEN"),rt.make_ref(getRef((void *)wxLIGHT_GREY_PEN,memenv), "wxPen")),
    enif_make_tuple2(rt.env, rt.make_atom("wxMEDIUM_GREY_BRUSH"),rt.make_ref(getRef((void *)wxMEDIUM_GREY_BRUSH,memenv), "wxBrush")),
    enif_make_tuple2(rt.env, rt.make_atom("wxMEDIUM_GREY_PEN"),rt.make_ref(getRef((void *)wxMEDIUM_GREY_PEN,memenv), "wxPen")),
    enif_make_tuple2(rt.env, rt.make_atom("wxNORMAL_FONT"),rt.make_ref(getRef((void *)wxNORMAL_FONT,memenv), "wxFont")),
    enif_make_tuple2(rt.env, rt.make_atom("wxNullBitmap"),rt.make_ref(getRef((void *)&wxNullBitmap,memenv), "wxBitmap")),
    enif_make_tuple2(rt.env, rt.make_atom("wxNullBrush"),rt.make_ref(getRef((void *)&wxNullBrush,memenv), "wxBrush")),
    enif_make_tuple2(rt.env, rt.make_atom("wxNullCursor"),rt.make_ref(getRef((void *)&wxNullCursor,memenv), "wxCursor")),
    enif_make_tuple2(rt.env, rt.make_atom("wxNullFont"),rt.make_ref(getRef((void *)&wxNullFont,memenv), "wxFont")),
    enif_make_tuple2(rt.env, rt.make_atom("wxNullIcon"),rt.make_ref(getRef((void *)&wxNullIcon,memenv), "wxIcon")),
    enif_make_tuple2(rt.env, rt.make_atom("wxNullPalette"),rt.make_ref(getRef((void *)&wxNullPalette,memenv), "wxPalette")),
    enif_make_tuple2(rt.env, rt.make_atom("wxNullPen"),rt.make_ref(getRef((void *)&wxNullPen,memenv), "wxPen")),
    enif_make_tuple2(rt.env, rt.make_atom("wxRED"), rt.make(*(wxRED))),
    enif_make_tuple2(rt.env, rt.make_atom("wxRED_BRUSH"),rt.make_ref(getRef((void *)wxRED_BRUSH,memenv), "wxBrush")),
    enif_make_tuple2(rt.env, rt.make_atom("wxRED_PEN"),rt.make_ref(getRef((void *)wxRED_PEN,memenv), "wxPen")),
    enif_make_tuple2(rt.env, rt.make_atom("wxSMALL_FONT"),rt.make_ref(getRef((void *)wxSMALL_FONT,memenv), "wxFont")),
    enif_make_tuple2(rt.env, rt.make_atom("wxSTANDARD_CURSOR"),rt.make_ref(getRef((void *)wxSTANDARD_CURSOR,memenv), "wxCursor")),
    enif_make_tuple2(rt.env, rt.make_atom("wxSWISS_FONT"),rt.make_ref(getRef((void *)wxSWISS_FONT,memenv), "wxFont")),
    enif_make_tuple2(rt.env, rt.make_atom("wxTRANSPARENT_BRUSH"),rt.make_ref(getRef((void *)wxTRANSPARENT_BRUSH,memenv), "wxBrush")),
    enif_make_tuple2(rt.env, rt.make_atom("wxTRANSPARENT_PEN"),rt.make_ref(getRef((void *)wxTRANSPARENT_PEN,memenv), "wxPen")),
    enif_make_tuple2(rt.env, rt.make_atom("wxWHITE"), rt.make(*(wxWHITE))),
    enif_make_tuple2(rt.env, rt.make_atom("wxWHITE_BRUSH"),rt.make_ref(getRef((void *)wxWHITE_BRUSH,memenv), "wxBrush")),
    enif_make_tuple2(rt.env, rt.make_atom("wxWHITE_PEN"),rt.make_ref(getRef((void *)wxWHITE_PEN,memenv), "wxPen")),
#if wxCHECK_VERSION(3,1,0)
